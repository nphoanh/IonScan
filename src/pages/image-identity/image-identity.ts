    ...
    saveImage(){
        ...
        if (this.data != null) { 
            ...
            this.sqlite.create({
                ...
                db.executeSql('INSERT INTO image VALUES (NULL,?,?,?,?,?,?,3)', [this.image.name,this.image.date,folderPath,this.picture,this.image.type,this.image.upload]).then(res => {
                    this.savebase64AsFile(folderPath, nameFile, base, this.image.type); 
                    this.navCtrl.push(IdentityBackPage,{pictureFront:this.pictureFront}); 
